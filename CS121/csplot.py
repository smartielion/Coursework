  ...
  Controls \n\
    ...
    def b1_down(self, event):
        ...
        # should have r for rotation...
             ...
             (self.keysdown.has_key("t") and self.keysdown["t"] == 1) or \
             (self.keysdown.has_key("z") and self.keysdown["z"] == 1):
            self.startx = event.x
            self.starty = event.y
        # nonuniform scaling
        # c for camera/rotation
    ...
    def b1_move(self,event):
        ...
        elif self.keysdown.has_key("z") and self.keysdown["z"] == 1:
            self.endx = event.x
            self.endy = event.y
            #create a box
    ...
    def b1_up(self,event):
        ...
        elif self.keysdown.has_key("s") and self.keysdown["s"] == 1:  
...
class CS5Canvas(ErdosCanvas):
    ...
    def lookup( self, colordatum, newColors = {} ):
        ...
        if self.tempDict.has_key(colordatum):
        ...
        if self.colorDictionary.has_key(colordatum):
